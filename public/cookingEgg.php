    ...
    <?php foreach ($eggs as $egg => $value) { ?>
        <div class="block_cards1"> <?php
            if ($eggs[$egg]['id'] == "5cac51240d488f0da6151bf5" || $eggs[$egg]['id'] == "5cac51240d488f0da6151c07" ||
                ...
                $eggs[$egg]['id'] == "5cac51240d488f0da6151c09" || $eggs[$egg]['id'] == "5cac51240d488f0da6151bcd" ||
                $eggs[$egg]['id'] == "5cac51240d488f0da6151bd1" || $eggs[$egg]['id'] == "5cac51240d488f0da6151be6" ||
                ...
                //if ($eggs[$egg]['id'] == "5cac51240d488f0da6151c07" || $eggs[$egg]['id'] == "5cac51240d488f0da6151bed"
                // || $eggs[$egg]['id'] == "5cac51240d488f0da6151c14" || $eggs[$egg]['id'] == "5cac51240d488f0da6151bf3") {
                    ?>
